...
<body>
	...
	<div class="p-5 bg-image" style="background-image: url('images/Service-Baner.png'); height: 550px;">
		<div class="row">
			<div class="col-lg-12">
				<h1>Our Services</h1>
	...
	<section class="special-program section-padding">
			...
			<div class="flex-container">
				...
				<br>
				<p>Meet with the experienced specialists, physicians and surgeons through Myancare application. The services are available at 24/7.</p>
				
				</div>
				
				<div class="flex-child">
				<img alt="program" src="https://myancare.org/wp-content/uploads/2021/07/Specialist.png">
				</div>
	...
	<section class="specialist-area  section-padding">
			...
			<div class="flex-container">
				...
				<div class="flex-child">
				<img alt="program" src="https://myancare.org/wp-content/uploads/2021/07/Home-care.png">
				</div>
				
				<div class="flex-child">
				<h4>Home HealthCare Service</h4>
				<br>
				<p>
				The patients can get healthcare access at home without going to the hospital or clinic.
				Depending on the individual patient’s situation, the healthcare services can range from nursing care to specialized medical services, such as medical checkup and physical or laboratory examinations.
				</p>
